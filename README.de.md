...
HobbyConnect*) und **Home Assistant**: Ein günstiger **ESP32-C3** verbindet sich
...
![Das „Karavan"-Dashboard in Home Assistant](docs/img/dashboard.png)
...
- Wohnwagen **Hobby De Luxe 495 UL** mit *HobbyConnect*.
